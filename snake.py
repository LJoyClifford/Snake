...
title_text = font.render("~Snake~", True, BLACK, RED)
title_rect = title_text.get_rect()
title_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2) # type: ignore

score_text = font.render("Score: " + str(score), True, BLACK, RED)
score_rect = score_text.get_rect()
score_rect.topleft = (10, 10)

game_over_text = font.render("GAMEOVER", True, BLACK, RED)
game_over_rect = game_over_text.get_rect()
game_over_rect.center = (WINDOW_WIDTH/2, WINDOW_HEIGHT//2)

continue_text = font.render("Press any key to play again", True, RED, BLACK)
